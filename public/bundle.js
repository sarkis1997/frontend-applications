...
var app = (function () {
   ...
   `;
    ...
    const file = "components/fetch.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(changed, ctx) {
    			if ((changed.data) && t0_value !== (t0_value = ctx.result.title.value + "")) {
    				set_data_dev(t0, t0_value);
    			}

    			if ((changed.data) && t2_value !== (t2_value = ctx.result.description.value + "")) {
    ...
    class Fetch extends SvelteComponentDev {
    	constructor(options) {
    		...
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "Fetch", options, id: create_fragment.name });
    	}
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	var hello = new Fetch({ $$inline: true });
